...
import com.myapp.userservice.request.LoginRequest;
import com.myapp.userservice.request.SignupRequest;
import com.myapp.userservice.response.JwtResponse;
import com.myapp.userservice.response.MessageResponse;
...
public class UserAuthController {
  ...
  public ResponseEntity<?> registerUser(HttpServletRequest request, @Valid @RequestBody SignupRequest signUpRequest) {
    TenantContextHolder.setTenantId(this.obtainTenantFromSubdomain(request));
